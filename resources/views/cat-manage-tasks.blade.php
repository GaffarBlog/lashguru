<!-- Begin Cat Manage Tasks Page Content -->
@extends('main')
@section('title') {{'Tasks Categories'}} @endsection
@section('main-container')
<!-- Cat Manage Tasks Page Start -->
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800">Admin Page: Tasks Categories</h1>
            ...
            <div class="card p-5 mt-5 mb-5">
                ...
                @if ( isset($_GET['leveltwo']) && isset($_GET['levelthree']) && isset($_GET['levelfour']) && isset($_GET['levelfive']) && isset($_GET['levelsix']) )
                    <div class="d-flex justify-content-between">
                        <h4 class="text-dark">Tasks Categories: {{ $level_six->count() }} Categories</h4>
                        <div class="d-flex justify-content-between">
                ...
                @elseif ( isset($_GET['leveltwo']) && isset($_GET['levelthree']) && isset($_GET['levelfour']) && isset($_GET['levelfive']) )
                    <div class="d-flex justify-content-between">
                        <h4 class="text-dark">Tasks Categories: {{ $level_five->count() }} Categories</h4>
                        <div class="d-flex justify-content-between">
                ...
                @elseif ( isset($_GET['leveltwo']) && isset($_GET['levelthree']) && isset($_GET['levelfour']) )
                    <div class="d-flex justify-content-between">
                        <h4 class="text-dark">Tasks Categories: {{ $level_four->count() }} Categories</h4>
                        <div class="d-flex justify-content-between">
                ...
                @elseif ( isset($_GET['leveltwo']) && isset($_GET['levelthree']) )
                    <div class="d-flex justify-content-between">
                        <h4 class="text-dark">Tasks Categories: {{ $level_three->count() }} Categories</h4>
                        <div class="d-flex justify-content-between">
                ...
                @elseif( isset($_GET['leveltwo']) )
                    <div class="d-flex justify-content-between">
                        <h4 class="text-dark">Tasks Categories: {{ $level_two->count() }} Categories</h4>
                        <div class="d-flex justify-content-between">
                            <a href="cat-manage-tasks" rel="noopener noreferrer"><i class="fas fa-angle-left"> Level One</i></a>
                        </div>
                    </div>
                @else
                    <h4 class="text-dark">Tasks Categories: {{ $cat_manage_tasks->count() }} Categories</h4>
                @endif
                ...
                <table class="table table-striped mt-4">
                    ...
                    <tbody id="cwBusinessCat">
                            ...
                            @if (!empty($level_six) && count($level_six))
                                @foreach($level_six as $level)
                                    <tr>
                                        ...
                                        <td class="align-middle">{{ $level->task_name }}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a href="?leveltwo={{$level->level_two }}&levelthree={{ $level->level_three }}&levelfour={{ $level->level_four }}&levelfive={{ $level->level_five }}&levelsix={{ $level->id }}">{{ $level->task_name }}</a>
                            ...
                            @if (!empty($level_four) && count($level_four))
                                @foreach($level_four as $level)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a href="?leveltwo={{$level->level_two }}&levelthree={{ $level->level_three }}&levelfour={{ $level->level_four }}&levelfive={{ $level->id }}">{{ $level->task_name }}</a>
                                                <span class="badge badge-pill badge-secondary">{{ $count[$index] }}</span>
                                            </div>
                                        </td>
                                        <td class="align-middle">
                            ...
                            @if (!empty($level_three) && count($level_three))
                                @foreach($level_three as $level)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a href="?leveltwo={{$level->level_two }}&levelthree={{ $level->level_three }}&levelfour={{ $level->id }}">{{ $level->task_name }}</a>
                                                <span class="badge badge-pill badge-secondary">{{ $count[$index] }}</span>
                                            </div>
                                        </td>
                                        <td class="align-middle">
                        ...
                        @elseif( isset($_GET['leveltwo']) )
                            @if (!empty($level_two) && count($level_two))
                                @foreach($level_two as $level)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a href="?leveltwo={{ $level->level_two }}&levelthree={{ $level->id }}">{{ $level->task_name }}</a>
                                                <span class="badge badge-pill badge-secondary">{{ $count[$index] }}</span>
                                            </div>
                                        </td>
                                        <td class="align-middle">
                            ...
                            @endif
                        @else
                            @if( !empty($cat_manage_tasks) && count($cat_manage_tasks) )
                                @foreach($cat_manage_tasks as $category)
                                    <tr>
                                        <td class="align-middle">{{ $category->id }}</td>
                                        <td class="align-middle">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a href="?leveltwo={{ $category->id }}">{{ $category->task_name }}</a>
                                                <span class="badge badge-pill badge-secondary">{{ $count[$index] }}</span>
                                            </div>
                                        </td>
                                        <td class="align-middle">
...
@endsection
<!-- End Cat Manage Tasks -->
<!-- Add Script File -->
@push('js')
    <script src="{{ asset('js/cat-manage-tasks.js?' . time() ) }}"></script>
@endpush
<!-- End Script File -->