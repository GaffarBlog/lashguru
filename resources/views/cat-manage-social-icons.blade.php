<!-- Begin Cat Manage Social Icons Categories Page Content -->
@extends('main')
@section('title') {{'Social Icons Categories'}} @endsection
@section('main-container')
<!-- Cat Manage Social Icons Categories Page Start -->
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800">Admin Page: Manage Social Icons Categories</h1>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card p-5 mt-5 mb-5">
                ...
                <h4 class="text-dark">Tasks Categories: {{ $cat_manage_social_icons->count() }} Categories</h4>
                ...
                <table class="table table-striped mt-4">
                    ...
                    <tbody id="cwBusinessCat">
                        @if( !empty($cat_manage_social_icons) && count($cat_manage_social_icons) )
                            @foreach($cat_manage_social_icons as $category)
                                <tr>
...
@endsection
<!-- End Cat Manage Social Icons Categories -->
<!-- Add Script File -->
@push('js')
    <script src="{{ asset('js/cat-manage-social-icons.js?' . time() ) }}"></script>
@endpush
<!-- End Script File -->