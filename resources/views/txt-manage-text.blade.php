...
@extends('main')
@section('title') {{'Manage Texts'}} @endsection
...
<div class="container-fluid">
    ...
    <h1 class="h3 mb-4 text-gray-800">Admin Page: Manage Texts</h1>
    <hr class="sidebar-divider rounded p-1 bg-primary text-white">
    <div class="cw-existing-content mt-4">
        ...
        @if ( !empty($business_contents) && count($business_contents) )
            @foreach ($business_contents as $business_content)
                <div class="d-flex justify-content-between mt-3">
                    <textarea class="form-control text-dark" readonly rows="3">{{ $business_content->content }}</textarea>
                    <button class="btn btn-primary my-4 mx-1 ml-2" id="cwEditContent" data-toggle="modal" data-target="#cwEditModal" data-id="{{ $business_content->id }}">Edit</button>
                    <button class="btn btn-danger my-4" id="cwDelContent" data-toggle="modal" data-target="#cwDelModal" data-id="{{ $business_content->id }}">Delete</button>
                </div>
            @endforeach
        @endif
    </div>
...
{{-- Edit Delete Modal --}}
<div class="modal fade" id="cwDelModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <!-- Modal body -->
            <div class="modal-body">Do you really want to remove this Content...</div>
            <!-- Modal footer -->
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-danger cw-delete-content">Delete</button>
            </div>
        </div>
    </div>
</div>
{{-- Edit Content Modal --}}
<div class="modal fade" id="cwEditModal">
            ...
            <div class="modal-body">
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        ...
                        @endif
                        <form method="POST" id="cwContentUpdate">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <label class="font-weight-bold">Please select a category:</label>
                                </div>
                                <div class="col-lg">
                                ...
                                <div class="col-12 mt-4">
                                    <div class="form-group">
                                        <label for="businesstext" class="font-weight-bold">Please write your text here:</label>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <button type="button" class="btn btn-primary cw-edit-content">Update</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@endpush
@push('js')
<script src="{{ asset('js/txk-manage-text.js') }}"></script>
<script>
