...
@extends('main')
@section('title') {{'Add Picture URL'}} @endsection
...
<div class="container-fluid">
    ...
    <h1 class="h3 mb-4 text-gray-800">Admin Page: Add Picture URL</h1>
            ...
            <form method="POST">
              @csrf
                <div class="form-group">
                  <label for="url">Here you can upload a single URL or multiple URLs (separated by comma).</label>
                  <textarea class="form-control" name="url" required id="url" rows="3"></textarea>
                </div>
                @error('url')
                  <span  class="alert alert-danger">{{$message}}</span>
                @enderror
                <center><input type="submit" name="cwuploadurl" class="btn btn-primary mt-3" value="Add Content"></center>
            </form>
        </div>
