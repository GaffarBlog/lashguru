...
@section('main-container')
    ...
    <div class="container-fluid" id="">
        ...
        <form method="post" action="{{ route('svg.store') }}" enctype="multipart/form-data">
            ...
            <div class="row mb-4">
                <div class="col-4">
                    <select name="sub_category_id" class="custom-select text-dark" id="subCategory">
                        <option class="bg-white text-dark default" value="">Select Category First</option>
                    </select>
                    @error('sub_category_id')
                        <span class="text-danger">Sub Category is required</span>
                    @enderror
            ...
            <div class=" card my-4 p-5">
                <div class="row">
                    <div class="col-3">
                        ...
                        <div class="input-group mb-3 rounded">
                            <div class="custom-file">
                                <input type="file" name="main_file_one" class="custom-file-input">
                                <label class="custom-file-label"
                                    aria-describedby="inputGroupFileAddon02"><span class="pr-2">Choose file</span></label>
                            </div>
                        </div>
                        @error('main_file_one')
                            <span class="text-danger">Please upload svg file only</span>
                        @enderror
                    </div>
                    <div class="col-3">
                        ...
                        <div class="input-group mb-3 rounded">
                            <div class="custom-file">
                                <input type="file" name="main_file_two" class="custom-file-input">
                                <label class="custom-file-label"
                                    aria-describedby="inputGroupFileAddon02"><span class="pr-2">Choose file</span></label>
                            </div>
                        </div>
                    ...
                    <div class="col-3">
                        ...
                        <div class="input-group mb-3 rounded">
                            <div class="custom-file">
                                <input type="file" name="main_file_three" class="custom-file-input">
                                <label class="custom-file-label"
                                    aria-describedby="inputGroupFileAddon02"><span class="pr-2">Choose file</span></label>
                            </div>
                        </div>
                        @error('main_file_three')
                            <span class="text-danger">Please upload svg file only</span>
                        @enderror
                    </div>
                    <div class="col-3">
                        ...
                        <div class="input-group mb-3 rounded">
                            <div class="custom-file">
                                <input type="file" name="main_file_four" class="custom-file-input">
                                <label class="custom-file-label"
                                    aria-describedby="inputGroupFileAddon02"><span class="pr-2">Choose file</span></label>
                            </div>
                        </div>
                        @error('main_file_four')
                            <span class="text-danger">Please upload svg file only</span>
                        @enderror
                    </div>
                </div>
                <div id="extension">
                    ...
                    @for ($i = 1; $i < 10; $i++)
                        <div class="row">
                            <div class="col-3">
                                <h4 class=" mb-1 text-dark">Extension (File {{$i}})
                                </h4>
                                <div class="input-group mb-3 rounded">
                                    <div class="custom-file">
                                        <input type="file" name="extension_{{$i}}" class="custom-file-input">
                                        <label class="custom-file-label"
        ...
        <div class="col mb-4 mt-1">
            <div class="card p-5">
                <table class="table">
                    ...
                    <tbody>
                        @foreach ($SvgMainContent as $item)
                        @php
                           $count = count(array_filter($item->toArray())) - 4;
                        @endphp
                            <tr>
                                <td>{{$item->id}}</td>
                                <td>Square Box {{$item->id < 10 ? "0" .$item->id : $item->id}}</td>
                                <td>{{$count}}</td>
                                <td>{{$item->subCategory->content_type}}</td>
