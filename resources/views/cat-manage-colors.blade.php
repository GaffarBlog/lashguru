<!-- Begin Cat Manage Colors Page Content -->
@extends('main')
@section('title') {{'Manage Colors'}} @endsection
@section('main-container')
<!-- Cat Manage Colors Page Start -->
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800">Admin Page: Manage Colors</h1>
            ...
            <div class="card p-5 mt-5 mb-5">
                ...
                @if( isset($_GET['leveltwo']) )
                    <div class="d-flex justify-content-between">
                        <h4 class="text-dark">Manage Colors: {{ $level_two->count() }} Categories</h4>
                        <div class="d-flex justify-content-between">
                            <a href="cat-manage-colors" rel="noopener noreferrer"><i class="fas fa-angle-left"> Level One</i></a>
                        </div>
                    </div>
                @else
                    <h4 class="text-dark">Manage Colors: {{ $cat_search_filters->count() }} Categories</h4>
                @endif
                            ...
                            @if( !empty($cat_search_filters) && count($cat_search_filters) )
                                @foreach($cat_search_filters as $category)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a href="?leveltwo={{ $category->id }}">{{ $category->color_name }}</a>
...
@endsection
<!-- End Cat Manage Colors -->
<!-- Add Script File -->
@push('js')
    <script src="{{ asset('js/cat-manage-colors.js?' . time() ) }}"></script>
@endpush
<!-- End Script File -->