$(document).ready(function() {
    ...
    $(cwEditCategory).on('click', function() {
        ...
        $.ajax({
            type: "GET",
            url: "/cat-manage-brands/edit/" + id,
            data: {
                '_token' : token,
                'id' : id
            },
            success: function (response) {
                let businessCat = response.cat_manage_brands;
                if( businessCat ) {
                    $('#cwUpdateCatName').val(businessCat.brand_name);
                }
            }
        });
    });
    ...
    $('.cw-update-category').on('click', function() {
        ...
        $.ajax({
            type : 'PUT',
            url : '/cat-manage-brands/update/' + id,
            dataType: 'json',
            data : {
                '_method': 'PUT',
    ...
    $('.cw-delete-category').on('click', function() {
        ...
        $.ajax({
            type : 'GET',
            url : '/cat-manage-brands/destroy/' + id,
            dataType: 'json',
            data : {
                '_token' : token,
                'id' : id,
