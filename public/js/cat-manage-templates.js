$(document).ready(function() {
    ...
    $(cwEditCategory).on('click', function() {
        ...
        $.ajax({
            type: "GET",
            url: "/cat-manage-templates/edit/" + id,
            data: {
                '_token' : token,
                'id' : id
            },
            success: function (response) {
                let businessCat = response.cat_manage_templates;
                if( businessCat ) {
                    $('#cwUpdateCatName').val(businessCat.temp_name);
                }
            }
        });
    });
    ...
    $('.cw-update-category').on('click', function() {
        ...
        $.ajax({
            type : 'PUT',
            url : '/cat-manage-templates/update/' + id,
            dataType: 'json',
            data : {
                '_method': 'PUT',
    ...
    $('.cw-delete-category').on('click', function() {
        ...
        $.ajax({
            type : 'GET',
            url : '/cat-manage-templates/destroy/' + id,
            dataType: 'json',
            data : {
                '_token' : token,
                'id' : id,
